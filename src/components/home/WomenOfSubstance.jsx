...
const WomenOfSubstance = () => {
    return (
        <div className="z-10 relative desktop:px-[10%] desktop:text-white px-4 py-[4%]">
            <div className="text-center text-[2.25rem] text-mg_primary font-andora mb-8 font-semibold">
                Magickal Journeys
            </div>
            <div className="flex flex-col desktop:flex-row font-lato items-center desktop:justify-evenly gap-2">
                <Link href="/article/jewels-by-priyanka">
                    <div className="w-[276px] desktop:border-none desktop:pb-0 desktop:mb-0 border-b-[1px] border-grey_light pb-6 mb-6 text-center">
                        ...
                        <div className="mt-6 text-[1.5rem] text-black font-bold">
                            <div>Jewels</div>
                            <div className=" text-grey_dark font-normal text-DT2">by <br/> Priyanka Maglani</div>
                        </div>
                    </div>
                </Link>
                <Link href="/article/nazaakat-chic">
                    <div className="w-[276px] text-center">
                        ...
                        <div className="text-black mt-6 text-[1.5rem] font-bold">
                            <div>Nazaakat Chic</div>
                            <div className=" text-grey_dark font-normal text-DT2">by <br/> Nita Sahney</div>
                        </div>
                    </div>
                </Link>
                {/* <div className="w-[276px] text-center">
